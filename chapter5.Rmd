...
```
The biplot is not very informative: the first PCA does not really succeed in teasing out the structure in the data.  
...
biplot(pca_human_scale, choices = 1:2, cex = c(0.8, 1), col = c("grey40", "deeppink2"))
```
